...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.day_week'
        db.add_column(u'schedule_event', 'day_week',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Event.start_time'
        db.add_column(u'schedule_event', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2014, 6, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'Event.end_time'
        db.add_column(u'schedule_event', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2014, 6, 6, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.day_week'
        db.delete_column(u'schedule_event', 'day_week')

        # Deleting field 'Event.start_time'
        db.delete_column(u'schedule_event', 'start_time')

        # Deleting field 'Event.end_time'
        db.delete_column(u'schedule_event', 'end_time')
    ...
    models = {
        ...
        'schedule.event': {
            ...
            'day_week': ('django.db.models.fields.IntegerField', [], {}),
